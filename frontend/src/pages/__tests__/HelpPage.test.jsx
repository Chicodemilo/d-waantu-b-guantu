...
// Created: 2026-06-25
// Purpose: Tests for the Help Center page (DWB-469) against the REAL helpContent
//          index (glob-discovered sections + quickStart). Covers: quick-start flow
//          steps and standalone callouts render as separate regions; domain sections
//          render under nav-mirroring group labels; sections start collapsed and
//          toggle open; fuzzy search filters live and force-opens matches; a no-match
//          query shows the empty state.
